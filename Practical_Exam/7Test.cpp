...
int main() {
    ...
    int randomNumber = 0, user_number = 0, Score = 100, in_gmae = 0, dif1 = 1, dif2 = 100 ;  
    while ( in_gmae == 0 ){ //#01
        Score = 100 ;  //rescore
        ...
        if ( in_gmae == 1 )//#01
        {
            ...
            do{
                ...
                scanf( "%d", &user_number ) ;
                if ( user_number == randomNumber ){//d1
                    printf( "That is correct! The winning number is %d.\n", randomNumber ) ;
                    printf( "Score this game: %d \n", Score ) ;
                }else if ( user_number < randomNumber ){//d1_1
                    Score -= 10 ;
                    printf( "Sorry, the winning number is HIGHER than %d. (Score=%d)\n", user_number, Score ) ;
                    dif2 = randomNumber + 3 ; //ใบ้เลขสุ่ม+3
                    dif1 = user_number + 1 ;
